...
def sorteia_dados():
    ...
    cores = filtra_cores(tubo=tubo_dos_jogadores) # conta quanto dados de cada cor tem no tubo
...
def next_player(motivo):
    ...
    # zera as variaveis que não serão contabilizadas
    ...
    if motivo == "tiro":
        print(
            "\t\033[1;31m|\033[0;0m\t\033[1;35m{}\033[0;0m \033[0;31mLEVOU 3 TIROS E PERDEU OS \033[1;32m{} CÉREBROS\033[0;0m \033[0;31mDESSA RODADA!!!\033[0;0m".format(
                ...
                cerebros_da_rodada))
        cerebros_comidos[jogador_da_vez]["quantidade"] -= cerebros_da_rodada
    ...
    if jogador_da_vez >= len(jogadores) - 1:
        jogador_da_vez = 0
    else:
        jogador_da_vez += 1
...
# estiliza o fundo dos dados com sua respectiva cor
...
# pede o nome de cada um dos jogadores e cria um index nas lista para cada jogador
    ...
    # se não possui dados suficiente para continuar
        ...
        while continuar != "S" and continuar != "N": # enquanto não for informado se deseja ou não continuar
            ...
            if continuar == "S" or continuar == "s":
                ...
                print("\tReutilizando {} dados de passos e {} dados do tubo para complementar 3 dados!".format(
                    len(dados_sorteados),
                    3 - len(
                        dados_sorteados)))
